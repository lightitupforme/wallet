...
export const SEND_AMOUNT_REQUEST = 'SEND_AMOUNT_REQUEST';

export const SEND_AMOUNT_SUCCESS = 'SEND_AMOUNT_SUCCESS';

export const SEND_AMOUNT_FAILURE = 'SEND_AMOUNT_FAILURE';

export const RESET_SEND_AMOUNT = 'RESET_SEND_AMOUNT';
